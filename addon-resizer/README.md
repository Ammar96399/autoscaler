...
```
sudo k0s kubectl get deployments -n kube-system -l k8s-app=$ADDON_NAME -L version
...
```
sudo k0s kubectl logs -n kube-system -l k8s-app=$ADDON_NAME -l version=$ADDON_VERSION -c
...
```
sudo k0s kubectl get deployment -n kube-system $ADDON_DEPLOYMENT -o yaml
```

### View current configuration

```
sudo k0s kubectl get configmap -n kube-system $ADDON_NAME-config -o yaml
```
...
```
sudo k0s kubectl edit configmap -n kube-system $ADDON_NAME-config -o yaml
```
...
```
sudo k0s kubectl delete deployment -n kube-system $ADDON_DEPLOYMENT
```
...
```
sudo k0s kubectl delete configmap -n kube-system $ADDON_NAME-config
```
